...
void PPEffectManagerState::describe() {
    ...
    int i = 0;
    for (std::pair<int, std::vector<PulseEffectAction>> l_pair : m_unorderedMapInt_vectorPulseEffectAction) {
    ...
    i = 0;
    for (std::pair<int, std::vector<CountTriggerAction>> l_pair : m_unorderedMapInt_vectorCountTriggerAction) {
    ...
    i = 0;
    for (std::pair<int, std::vector<TimerTriggerAction>> l_pair : m_unorderedMapInt_vectorTimerTriggerAction) {
